...
C_SRCS += \
../Switch/common/boardprofile/bprofile_YT9215SC_default_demo.c 

C_DEPS += \
./Switch/common/boardprofile/bprofile_YT9215SC_default_demo.d 

OBJS += \
./Switch/common/boardprofile/bprofile_YT9215SC_default_demo.o 


# Each subdirectory must supply rules for building sources it contributes
Switch/common/boardprofile/%.o: ../Switch/common/boardprofile/%.c Switch/common/boardprofile/subdir.mk
	@echo 'Building file: $<'
